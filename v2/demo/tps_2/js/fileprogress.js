...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		progressBar.appendChild(document.createTextNode(Math.ceil(file.size/1024) + ' KB'));

		var progressStatus = document.createElement("td");
		progressStatus.className = "progressBarStatus";
		progressStatus.appendChild(document.createTextNode(Math.ceil(file.size/1024) + ' KB'));
		
		var progressUrl = document.createElement("td");
		progressUrl.className = "progressUrl";
		progressUrl.appendChild(document.createTextNode("http://loaclhost/tps/upload/" +file.name));
