...
InfoBox.prototype.createElement = function() {
  ...
  if (!div) {
    ...
    contentDiv.innerHTML = '<div class="pop_tips"><h4 class="title">AVENIR</h4><p class="desc">冲着苏有朋才选择收看此片,没想到吴佩慈的演技那么差....</p></div>';
    ...
    function removeInfoBox(ib) {
      return function() {
		document.getElementById('comment_detail').className='comment_detail slicedown';
        ib.setMap(null);
      };
    }
  ...
  this.boundsChangedListener_ = null;
	...
	for(var i=0;i<10;i++){
		marker [i]=	new google.maps.Marker({
			...
			map: map,
			icon:'static/avatar_'+i+'.jpg'
    	});
		google.maps.event.addListener(marker[i], 'click', function() {
			document.getElementById('comment_detail').className='comment_detail sliceup';										
